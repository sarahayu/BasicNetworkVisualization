...
public struct SplineData
{
    ...
    public SplineData(uint Idx, uint NumSegments, uint BeginSplineSegmentIdx, uint NumSamples, uint BeginSamplePointIdx, Vector3 StartPosition, Vector3 EndPosition, Color StartColorRGBA, Color EndColorRGBA, uint LinkState)
    {
        this.Idx = Idx;
